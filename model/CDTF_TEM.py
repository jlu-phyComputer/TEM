...
class Model(nn.Module):
    def __init__(self, configs):
        ...
        self.pi_1 = nn.Parameter(torch.tensor([1.0, 1.0, 0.0] * configs.e_layers))
        self.pi_2 = nn.Parameter(torch.tensor([1.0, 1.0, 1.0] * configs.e_layers))
        self.pi_s1 = nn.Parameter(torch.tensor([0.01] * configs.e_layers * configs.n_heads))
        self.pi_s2 = nn.Parameter(torch.tensor([0.01] * configs.e_layers * configs.n_heads))
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        (dec_out, dec_out_c_v, dec_out_c_t) = self.encoder(x_enc, x_mark_enc=x_mark_enc, attn_mask=None,
                                                           pi1=self.pi_1, pi2=self.pi_2, pis1=self.pi_s1, pis2=self.pi_s2)
        ...
        return [dec_out, dec_out_c_v, dec_out_c_t]
