...
def main():
    ...
    parser.add_argument('--c_out', type=int, default=321, help='output size') # applicable on arbitrary number of variates in inverted Transformers
    ...
    parser.add_argument('--learning_rate', type=float, default=0.0012, help='optimizer learning rate')
